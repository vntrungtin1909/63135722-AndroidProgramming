...
public class Cau5Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        AppCompatButton btn = view.findViewById(R.id.button);
        ...
        btn.setOnClickListener(v -> openNewFragment(new DHNTFragment()));
    ...
    private void openNewFragment(Fragment fragment) {
        ...
        transaction.addToBackStack(null); // Để quay lại Fragment trước đó bằng nút back trên điện thoại
        transaction.commit();
    }
}